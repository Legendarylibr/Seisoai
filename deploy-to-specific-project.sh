...
echo "🚀 Deploying to specific Railway project..."

# Set the project ID from the URL
PROJECT_ID="ee55e7fa-b010-4946-a87b-013e15e329a8"
ENVIRONMENT_ID="453691b3-3d89-494c-8cc7-6793f671a87e"

echo "📦 Project ID: $PROJECT_ID"
echo "🌍 Environment ID: $ENVIRONMENT_ID"

# Try to link to the project using Railway CLI
echo "🔗 Attempting to link to project..."
railway link --project $PROJECT_ID --environment $ENVIRONMENT_ID

# Check if we're now connected to the right project
