    ...
    <div className="w-full max-w-md md:max-w-xl mx-auto max-h-full overflow-hidden">
      <div className="glass-card rounded-xl p-3 sm:p-6 md:p-8 space-y-3 sm:space-y-6 md:space-y-8 relative overflow-hidden">
        ...
        <div className="text-center relative z-10">
          <div 
            className="w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 rounded-xl flex items-center justify-center mx-auto mb-2 sm:mb-4 md:mb-6 transition-transform duration-300 hover:scale-105"
            style={{
          ...
          >
            <Mail className="w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10" style={{ color: '#000000', filter: 'drop-shadow(0 0 4px rgba(0, 212, 255, 0.3))' }} />
          </div>
          <h2 className="text-2xl sm:text-2xl md:text-3xl font-bold mb-1 sm:mb-2 md:mb-3 tracking-wide" style={{ 
            color: '#000000', 
          ...
          <p className="text-sm sm:text-sm md:text-base" style={{ 
            color: '#1a1a2e', 
        ...
        <form onSubmit={handleSubmit} className="space-y-2 sm:space-y-4 md:space-y-6" noValidate>
          {/* Email Input */}
          <div>
            <label className="block text-sm sm:text-sm md:text-base font-medium mb-1 sm:mb-2 md:mb-3" style={{ color: '#000000', textShadow: '1px 1px 0 rgba(255, 255, 255, 0.8)' }}>
              Email
            </label>
            <div className="relative">
              <Mail className="absolute left-3 sm:left-3 md:left-4 top-1/2 transform -translate-y-1/2 w-5 h-5 sm:w-5 sm:h-5 md:w-6 md:h-6" style={{ color: '#000000' }} />
              <input
                type="email"
                name="email"
                value={email}
                ...
                className="w-full pl-10 sm:pl-10 md:pl-12 pr-3 sm:pr-4 md:pr-5 py-2.5 sm:py-3 md:py-4 rounded text-sm sm:text-sm md:text-base"
                style={{
          ...
          <div>
            ...
            <div className="relative">
              <Lock className="absolute left-3 sm:left-3 md:left-4 top-1/2 transform -translate-y-1/2 w-5 h-5 sm:w-5 sm:h-5 md:w-6 md:h-6" style={{ color: '#000000' }} />
              <input
                ...
                placeholder="••••••••"
                className="w-full pl-10 sm:pl-10 md:pl-12 pr-10 sm:pr-12 md:pr-14 py-2.5 sm:py-3 md:py-4 rounded text-sm sm:text-sm md:text-base"
                style={{
                  background: 'linear-gradient(to bottom, #ffffff, #f8f8f8)',
                  border: '2px inset #c0c0c0',
                  boxShadow: 'inset 3px 3px 0 rgba(0, 0, 0, 0.25), inset -1px -1px 0 rgba(255, 255, 255, 0.5)',
              ...
              <button
                ...
                className="absolute right-3 sm:right-3 md:right-4 top-1/2 transform -translate-y-1/2 transition-colors"
                style={{ color: '#000000' }}
              >
                {showPassword ? (
                  <EyeOff className="w-5 h-5 sm:w-5 sm:h-5 md:w-6 md:h-6" />
                ) : (
                  <Eye className="w-5 h-5 sm:w-5 sm:h-5 md:w-6 md:h-6" />
                )}
              </button>
            </div>
            {/* Password Requirements (only shown on signup) */}
            {isSignUp && (
              <div className="mt-1.5 sm:mt-2 md:mt-3 p-2 sm:p-3 md:p-4 rounded text-xs sm:text-xs md:text-sm" style={{
                ...
                <ul className="list-disc list-inside space-y-0 sm:space-y-0.5 md:space-y-1 text-[11px] sm:text-[10px] md:text-xs">
          ...
          {isSignUp && (
            <div>
              ...
              {confirmPassword && (
                <div className="mt-0.5 sm:mt-1 text-xs sm:text-xs md:text-sm" style={{ 
          ...
          {displayError && (
            <div 
              className="p-2 sm:p-3 md:p-4 rounded text-sm sm:text-sm md:text-base flex items-start gap-2 sm:gap-3"
              style={{
          ...
          <button
            ...
            className="w-full btn-primary py-2.5 sm:py-3 md:py-4 flex items-center justify-center gap-2 text-sm sm:text-sm md:text-base disabled:opacity-70 disabled:cursor-not-allowed"
          >
            {(isLoading || isSubmitting) ? (
              <>
                <div 
                  className="w-5 h-5 sm:w-5 sm:h-5 md:w-6 md:h-6 border-2 border-t-transparent rounded-full animate-spin"
        ...
        <div className="text-center">
          <button
            ...
            className="text-sm sm:text-sm md:text-base transition-colors"
