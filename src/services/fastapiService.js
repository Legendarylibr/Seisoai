...
export const isFastAPIAvailable = async () => {
  ...
  try {
    ...
    logger.warn('FastAPI service not available:', { error: error.message });
    return false;
  }
};
...
export const generateImageWithFastAPI = async (style, customPrompt = '', advancedSettings = {}, referenceImage = null) => {
  ...
  try {
    ...
    logger.error('FastAPI generation error:', { error: error.message });
...
export const getAvailableModels = async () => {
  ...
  try {
    ...
    logger.warn('Could not fetch models from FastAPI:', { error: error.message });
    return [];
  }
};
...
export const getGenerationStatus = async (taskId) => {
  ...
  try {
    ...
    logger.warn('Could not fetch generation status:', { error: error.message });
    return null;
  }
};
