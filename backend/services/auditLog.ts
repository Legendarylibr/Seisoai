...
export enum AuditEventType {
  ...
  // Agent events (security-sensitive)
  AGENT_CREATED = 'AGENT_CREATED',
  AGENT_DELETED = 'AGENT_DELETED',
  AGENT_PROMPT_SANITIZED = 'AGENT_PROMPT_SANITIZED',
  
  // API Key events (security-sensitive)
  API_KEY_CREATED = 'API_KEY_CREATED',
  API_KEY_REVOKED = 'API_KEY_REVOKED',
  API_KEY_WEBHOOK_BLOCKED = 'API_KEY_WEBHOOK_BLOCKED',
}
